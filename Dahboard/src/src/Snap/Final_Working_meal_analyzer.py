...
class MealAnalyzer:
    def __init__(self):
        ...
        api_key = "AIzaSyAH5vwOH_QCqRpfz2yw1ZZ6C_gF1Y8sv8k"
        if not api_key:
    ...
    def analyze_meal(self, image_path):
        ...
        # Return complete analysis - removed print statements
...
if __name__ == "__main__":
    ...
    print(result)  # Just print the JSON string without any additional output
...
const HomePage = () => {
  ...
  const testimonials = [
    ...
    },
    {
      ...
      image: "https://media.istockphoto.com/id/1410538853/photo/young-man-in-the-public-park.jpg?s=612x612&w=0&k=20&c=EtRJGnNOFPJ2HniBSLWKzsL9Xf7GHinHd5y2Tx3da0E=",
      quote:
    ...
    },
    {
      ...
      image: "https://cdn2.stylecraze.com/wp-content/uploads/2013/07/Women-With-Beautiful-Face.jpg.webp",
      quote:
  ...
  return (
    <ParallaxProvider>
      ...
      >
          ...
          <div className="container mx-auto px-4 grid md:grid-cols-2 gap-8 items-center py-20">
            ...
            >
              ...
              >
                ...
                <span className=" from-primary to-green-500 bg-clip-text ">
                  Transform Your Life
                </span>
              </motion.h1>
              <motion.p
              ...
              >
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="bg-gradient-to-r from-primary to-green-500 text-white px-8 py-3 rounded-full font-medium flex items-center gap-2 shadow-lg shadow-primary/20"
                >
                  Get Started
        ...
        {/* Mobile App Preview */}
        <section className="py-20 bg-gradient-to-b from-blue-100/50 to-transparent overflow-hidden">
          <div className="container mx-auto px-4">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <motion.div
                initial={{ opacity: 0, x: -30 }}
              ...
              <motion.div
                ...
                className="relative"
              >
                <div className="absolute inset-0 bg-gradient-to-r from-primary/10 to-green-500/10 rounded-full blur-3xl -z-10" />
                <img
        ...
        {/* CTA Section */}
        <section className="py-20 bg-gradient-to-r from-primary to-green-500 ">
